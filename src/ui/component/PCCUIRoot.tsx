...
const ToggleNameMp: Record<string, string | undefined> = {
  drive_holder: 'Panneau latéral arrière',
  front_panel: 'Panneau avant',
  side_armour: 'Vis du boîtier',
  side_glass: 'Panneau latéral avant',
  power_nail: 'Vis alimentation',
};
    ...
    <EmptyMountPointDiv key={name}>
      <EmptyMountPointInnerDiv onClick={() => onClick(mountPoint)}>
        ...
        <MountPointAttachHintDiv>
          Cliquez pour ajouter un nouveau composant
        </MountPointAttachHintDiv>
