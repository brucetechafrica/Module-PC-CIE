...
const FileNameMap: Record<string, string | undefined> = {
  case_sample: 'Boîtier PC', // 机箱
  '120mm_fan_sample': 'Ventilateur 120mm', // 120mm 风扇
  atx_motherboard_sample: 'Carte Mère ATX', // ATX 主板
  cooler_sample: 'Refroidisseur Air', // 风冷散热
  cpu_sample: 'Processeur (CPU)', // CPU
  gpu_sample: 'Carte Graphique (GPU)', // GPU
  ddr4_ram_sample: 'Mémoire RAM DDR4', // DDR4 内存条
  nvme_ssd_sample: 'Disque SSD NVMe', // 固态硬盘
  atx_power_sample: 'Bloc d’Alimentation ATX', // ATX 电源
};
